...
add_level(cursor, "Арифметика",
          ...
          3132,
          "Розга срывается со стены и ударами рассекает вас на раз-два-три части.",
          "levels/task_3.png")
...
add_level(cursor, "Сад",
          "Тихий сад встречает вас гудением пчел и чарующим ароматом апельсинов.",
          4143,
          "Упс, у вас ведь аллергия на пчел...",
          "levels/task_5.png")


add_level(cursor, "Лукоморье",
          "Вы чувствуете мурашки по спине: здесь на неведанных дорожках следы невиданных зверей...",
          1212,
          "Выстрел в живот. Черная речка поглощает ваше окровавленное тело.",
          "levels/task_7.png")

add_level(cursor, "Друзья Дороти",
          "В воздухе чувствуется волшебство. Сердце подсказывает вам, что стоит идти в сторону тех далеких"
          " изумрудных башен, но какой дорогой?",
          2222,
          "Ведьма Гингема делает с вами нехорошие магические вещи. Вы умираете.",
          "levels/task_8.png")
